...
class UserListRepository {
    ...
    val userListResponse = MutableLiveData<FirestoreResponse<ArrayList<User>>>()
                ...
                db.collection(Hiya.USERS_COLLECTION_PATH)
                    ...
                    .addOnSuccessListener { snapshot ->
                        if (!snapshot.isEmpty) {
                            ...
                            userListResponse.value = FirestoreResponse.success(matchingContacts)
                        }
                    }
                    .addOnFailureListener { exception ->
                        userListResponse.postValue(
